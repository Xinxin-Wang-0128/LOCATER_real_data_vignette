...
experiment_name="2-wg-screening"
...
do
	echo "export APPTAINER_BIND="/home/xw445:/home/xw445"; apptainer exec /home/xw445/scripts/container-setup/mini-shark-nov28 ${grand_dir}whole_genome_screening/2-screening/run_jobs whole_genome_screening ${experiment_name} ${nthreads} ${i}" >> ${job_file_name}
...
# ${grand_dir}whole_genome_screening/2-screening/run_jobs: executable file that runs a R script with some environment variables
